...
This project is the application built using the Android support lib, its set to target devices on Android 2.2 (API Level 8) or higher.
To see this same application built to target only those devices with native Fragment support, see the project in the ProtectAgainstUnexpected folder.
