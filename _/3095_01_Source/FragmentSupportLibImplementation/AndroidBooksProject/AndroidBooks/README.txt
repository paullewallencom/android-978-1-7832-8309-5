...
This project is the Fragment-based application built to support platforms that do not natively support Fragments (API Level < 11).
This project represents the application as the chapter ends. This project is specifically set to target devices on Android 2.2 (API Level 8) or higher.
To see this same application built to target only those devices with native Fragment support, see the project in the FragmentImplementation folder.
